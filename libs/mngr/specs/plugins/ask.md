...
# or run in unhinged mode by just executing whatever "mngr ask" returns:
`mngr ask start a container with claude code and forward port 8080 to the public internet`
```
