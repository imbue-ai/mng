...
class CertifiedHostData(FrozenModel):
    ...
    # TODO: I've added all of these fields by moving them from the modal host record class
    #  They should be set when the host is created/started and saved to data.json, and the data should be stored here now, not in HostRecord
