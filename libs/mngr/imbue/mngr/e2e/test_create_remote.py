...
def test_create_provider_modal(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --no-ensure-clean",
...
def test_create_modal_edit_message(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --edit-message --no-ensure-clean",
...
def test_create_modal_rsync(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            'mngr create my-task --provider modal --rsync --rsync-args "--exclude=node_modules" --no-ensure-clean',
...
def test_create_modal_passthrough_agent_args(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            'mngr create my-task --provider modal --no-ensure-clean -- --dangerously-skip-permissions --append-system-prompt "Don\'t ask me any questions!"',
...
def test_create_modal_idle_timeout(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --idle-timeout 60 --no-ensure-clean",
...
def test_create_modal_idle_mode_ssh(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            'mngr create my-task --provider modal --idle-mode "ssh" --no-ensure-clean',
...
def test_create_modal_build_args(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal -b cpu=4 -b memory=16 -b image=python:3.12 --no-ensure-clean",
...
def test_create_modal_dockerfile_and_context(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal -b file=./Dockerfile.agent -b context-dir=./agent-context --no-ensure-clean",
...
def test_create_named_host_new_host(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task@my-modal-box.modal --new-host --no-ensure-clean",
...
def test_create_modal_volume(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal -b volume=my-data:/data --no-ensure-clean",
...
def test_create_modal_snapshot(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --snapshot snap-123abc --no-ensure-clean",
...
def test_create_docker_start_args(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            'mngr create my-task --provider docker -s "--gpus all" --no-ensure-clean',
...
def test_create_modal_target_path(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --target-path /workspace --no-ensure-clean",
...
def test_create_modal_upload_and_user_command(e2e: E2eSession) -> None:
    ...
    mngr create my-task --provider modal --upload-file ~/.ssh/config:/root/.ssh/config --user-command "pip install foo"
    # (--sudo-command runs as root; --append-to-file and --prepend-to-file are also available)
    """)
    _assert_provider_disabled(
        e2e.run(
            'mngr create my-task --provider modal --upload-file ~/.ssh/config:/root/.ssh/config --user-command "pip install foo" --no-ensure-clean',
...
def test_create_modal_no_start_on_boot(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --no-start-on-boot --no-ensure-clean",
...
def test_create_modal_pass_host_env(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "MY_VAR=hello mngr create my-task --provider modal --pass-host-env MY_VAR --no-ensure-clean",
...
def test_create_modal_reuse(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create sisyphus --reuse --provider modal --no-ensure-clean",
...
def test_create_modal_retry(e2e: E2eSession) -> None:
    ...
    _assert_provider_disabled(
        e2e.run(
            "mngr create my-task --provider modal --retry 5 --retry-delay 10s --no-ensure-clean",
