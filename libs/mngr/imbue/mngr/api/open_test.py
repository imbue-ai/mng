...
# Collects URLs that would be opened during tests (via the open_url injectable)
_intercepted_urls: list[str] = []


def _capture_url(url: str) -> None:
    """Test-only open_url callback that captures the URL instead of opening a browser."""
