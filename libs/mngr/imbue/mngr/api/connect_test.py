...
def test_build_ssh_activity_wrapper_script_creates_activity_directory() -> None:
    ...
    script = _build_ssh_activity_wrapper_script("mngr-test-session", Path("/home/user/.mngr"), None)
...
def test_build_ssh_activity_wrapper_script_attaches_to_tmux_session() -> None:
    ...
    script = _build_ssh_activity_wrapper_script("mngr-my-agent", Path("/home/user/.mngr"), None)
...
def test_build_ssh_activity_wrapper_script_kills_activity_tracker_on_exit() -> None:
    ...
    script = _build_ssh_activity_wrapper_script("mngr-test", Path("/tmp/.mngr"), None)
...
def test_build_ssh_activity_wrapper_script_handles_paths_with_spaces() -> None:
    ...
    script = _build_ssh_activity_wrapper_script("mngr-test", Path("/home/user/my dir/.mngr"), None)
...
def test_build_ssh_activity_wrapper_script_signal_file_uses_session_name() -> None:
    ...
    script = _build_ssh_activity_wrapper_script("mngr-unique-session", Path("/data/.mngr"), None)
