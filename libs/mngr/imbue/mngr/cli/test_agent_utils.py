...
def test_select_agent_interactively_with_host_returns_selected_agent(
    ...
    with tmux_session_cleanup(session_name):
        create_test_agent_via_cli(
            cli_runner, temp_work_dir, mngr_test_prefix, plugin_manager, agent_name, agent_cmd="sleep 564738"
        )
...
def test_select_agent_interactively_with_host_returns_none_when_user_quits(
    ...
    with tmux_session_cleanup(session_name):
        create_test_agent_via_cli(
            cli_runner, temp_work_dir, mngr_test_prefix, plugin_manager, agent_name, agent_cmd="sleep 564739"
        )
...
def test_find_agent_for_command_with_stopped_agent_and_skip_agent_state_check(
    ...
    with tmux_session_cleanup(session_name):
        create_test_agent_via_cli(
            cli_runner, temp_work_dir, mngr_test_prefix, plugin_manager, agent_name, agent_cmd="sleep 564740"
        )
...
def test_find_agent_for_command_raises_for_stopped_agent_without_skip(
    ...
    with tmux_session_cleanup(session_name):
        create_test_agent_via_cli(
            cli_runner, temp_work_dir, mngr_test_prefix, plugin_manager, agent_name, agent_cmd="sleep 564741"
        )
