...
# FIXME: When "mngr cleanup" is implemented, add a cross-reference in the gc command's [attempts=15]
...
# (attempt 2) Still not actionable: cleanup.md still has [future] tag, no cleanup CLI command exists.
# (attempt 3) Still not actionable: cleanup.md still has [future] tag, no cleanup.py CLI module exists.
# (attempt 4) Still not actionable: cleanup.md still has [future] tag, no cleanup.py exists, no CLI registration.
# (attempt 5) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
# (attempt 6) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
...
# (attempt 11) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
# (attempt 12) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
# (attempt 13) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
# (attempt 14) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
# (attempt 15) Still not actionable: cleanup.md still has [future] tag, no cleanup.py or CLI registration exists.
