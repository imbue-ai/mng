...
def test_get_snapshots_delegates_to_provider(offline_host: OfflineHost, fake_provider: FakeProviderInstance):
...
def test_get_tags_delegates_to_provider(offline_host: OfflineHost):
...
def test_get_state_returns_crashed_when_no_stop_reason(offline_host: OfflineHost):
