...
## 1. AgentInfo.type uses plain str instead of AgentTypeName [future]
...
## 2. CertifiedHostData.image uses plain str instead of ImageReference [future]
...
## 3. HostInfo.name uses plain str instead of HostName [future]
...
## 4. VolumeInfo uses plain int instead of SizeBytes for size_bytes [future]
...
## 5. SnapshotInfo.size_bytes uses plain int instead of SizeBytes [future]
...
## 6. HookDefinition.command uses plain str instead of CommandString [future]
...
## 7. Plugin interfaces use plain str instead of PluginName [future]
...
## 8. Agent registry functions use plain str instead of AgentTypeName [future]
...
## 9. AgentInfo.idle_mode uses plain str instead of IdleMode enum [future]
...
## 11. ConnectionOptions.attach_command uses plain str instead of CommandString [future]
...
## 12. Provider/Plugin config registry functions use plain str [future]
...
## 13. EnvVar should use typed keys for environment variable names [future]
...
## 14. ModalProviderInstance uses plain str for app_name [future]
...
## 15. GitOptions branch-related fields use plain str [future]
...
## 16. Various timeout/duration fields use plain int instead of typed durations [future]
...
## 17. Resource counts use plain int without validation [future]
...
## 18. recency_idx uses plain int without validation [future]
