...
**mng is fast:**
```bash
> time mng local-hello  --message "Just say hello" --no-connect --await-ready --in local
# (time results)

> time mng remote-hello --message "Just say hello" --no-connect --await-ready --in modal
# (time results)
