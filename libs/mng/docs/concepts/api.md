...
Plugins interact with mng by implementing hooks (defined in `hookspecs.py`). There are two kinds:
...
mng calls these on your plugin at specific points during command execution. Implement them to react to events or modify behavior.
