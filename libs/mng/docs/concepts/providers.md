...
There are some built-in provider instances (`local` and `local_docker`), but you generally define your own in your `mng` settings:
...
See [`imbue/mng/interfaces/provider.py`](../../imbue/mng/interfaces/provider.py) for the full provider interface.
