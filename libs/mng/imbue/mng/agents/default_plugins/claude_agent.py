...
def _prompt_user_for_trust(source_path: Path) -> bool:
    ...
    logger.info(
        ...
        "mng needs to add a trust entry to ~/.claude.json so that Claude Code\n"
        ...
        if options.git and options.git.copy_mode == WorkDirCopyMode.WORKTREE:
            ...
            if git_common_dir is not None:
                ...
                try:
                    ...
                    if mng_ctx.is_auto_approve or (mng_ctx.is_interactive and _prompt_user_for_trust(source_path)):
