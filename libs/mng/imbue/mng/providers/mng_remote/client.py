...
class MngRemoteClient(FrozenModel):
    """HTTP client for communicating with a remote mng API server."""

    base_url: str = Field(description="Base URL of the remote mng API server")
    ...
    def list_agents(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            logger.warning("Failed to fetch agents from remote mng at {}: {}", self.base_url, e)
            raise ProviderError(f"Failed to connect to remote mng API at {self.base_url}: {e}") from e
