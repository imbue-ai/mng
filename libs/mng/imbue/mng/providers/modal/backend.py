...
# These are generated by load_or_create_ssh_keypair() and load_or_create_host_keypair()
# and should not be baked into deployment images. The deployed environment generates
# fresh keypairs as needed.
