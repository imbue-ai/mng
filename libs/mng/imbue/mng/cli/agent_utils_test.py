...
from imbue.mng.cli.agent_utils import _host_matches_filter
from imbue.mng.cli.agent_utils import filter_agents_by_host
...
def test_select_agent_interactively_raises_when_no_agents(
    ...
    with pytest.raises(UserInputError, match="No agents found"):
        select_agent_interactively_with_host(temp_mng_ctx)
