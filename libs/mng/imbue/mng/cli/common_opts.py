...
from imbue.mng.providers.registry import load_non_disabled_backends
from imbue.mng.providers.registry import register_config_classes
...
def setup_command_context(
    ...
    load_non_disabled_backends(pm, mng_ctx.config.disabled_plugins)
