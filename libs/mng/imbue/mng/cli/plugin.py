...
def plugin(ctx: click.Context, **kwargs: Any) -> None:
    ...
    View, enable, and disable plugins registered with mng.
...
def plugin_add(ctx: click.Context, name: str, **kwargs: Any) -> None:
    """Add a plugin. [future]"""
    raise NotImplementedError("'mng plugin add' is not yet implemented")
...
def plugin_remove(ctx: click.Context, name: str, **kwargs: Any) -> None:
    ...
    raise NotImplementedError("'mng plugin remove' is not yet implemented")
...
View, enable, and disable plugins registered with mng. Plugins provide
