...
def load_config(
    ...
    config_dict["tmux_server_socket_name"] = config.tmux_server_socket_name
...
def parse_config(
    ...
    kwargs["tmux_server_socket_name"] = (
        raw.pop("tmux_server_socket_name", None) if "tmux_server_socket_name" in raw else None
    )
