...
def test_schedule_remove_raises_not_implemented(
    cli_runner: CliRunner,
    plugin_manager: pluggy.PluginManager,
) -> None:
    """Test that schedule remove raises NotImplementedError."""
    result = cli_runner.invoke(
        schedule,
        ["remove", "my-trigger"],
        obj=plugin_manager,
...
def test_schedule_list_raises_not_implemented(
    cli_runner: CliRunner,
    plugin_manager: pluggy.PluginManager,
) -> None:
    """Test that schedule list raises NotImplementedError."""
    result = cli_runner.invoke(
        schedule,
        ["list"],
        obj=plugin_manager,
...
def test_schedule_run_raises_not_implemented(
    cli_runner: CliRunner,
    plugin_manager: pluggy.PluginManager,
) -> None:
    """Test that schedule run raises NotImplementedError."""
    result = cli_runner.invoke(
        schedule,
        ["run", "my-trigger"],
        obj=plugin_manager,
...
def test_schedule_update_raises_not_implemented(
    ...
    """Test that schedule update raises NotImplementedError."""
    result = cli_runner.invoke(
        schedule,
        ["update", "my-trigger"],
        obj=plugin_manager,
