...
AGENT_STATES_SOURCE = "mng/agent_states"
...
def watch_for_waiting_agents(
    ...
    """Watch the mng observe event stream for RUNNING -> WAITING transitions.

    Tails the agent_states events file written by `mng observe` and sends
