...
from imbue.mngr_tmr.api import PLUGIN_NAME
from imbue.mngr_tmr.api import _build_agent_options
from imbue.mngr_tmr.api import _build_agent_prompt
from imbue.mngr_tmr.api import _build_grouped_tables
from imbue.mngr_tmr.api import _build_stacked_bar
from imbue.mngr_tmr.api import _copy_mode_for_provider
from imbue.mngr_tmr.api import _render_markdown
...
from imbue.mngr_tmr.api import display_category_of
from imbue.mngr_tmr.api import generate_html_report
...
from imbue.mngr_tmr.data_types import DisplayCategory
...
def test_generate_html_report_with_integrator(tmp_path: Path) -> None:
    ...
    assert "mngr-tmr/integrated-abc123" in content
    assert "mngr-tmr/a" in content
