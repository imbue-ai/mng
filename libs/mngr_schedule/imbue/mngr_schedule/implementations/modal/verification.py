...
# real Modal and mngr infrastructure to execute (similar to cron_runner.py).
...
def _resolve_agent(agent_name: str, mngr_ctx: MngrContext) -> AgentInterface:
...
def _stream_process_output(
    ...
    for line in process.stdout:
        ...
        # Extract agent name from mngr create output
...
def verify_schedule_deployment(
    ...
    5. If is_finish_initial_run is True, resolves the agent via the mngr Python API,
