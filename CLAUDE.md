...
- For faster iteration, add "-nauto" to use all CPU cores (default is 4 workers). Do not change the default in pyproject.toml since -nauto doesn't work well in CI.
