...
1. User runs: `changeling deploy elena-turing`
   ("elena-turing" is a changeling name -- each changeling has a unique name like "elena-turing", "code-reviewer", etc.)
...
3. User answers some questions:
   - What do you want to name the agent? [elena-turing | <type something>]
